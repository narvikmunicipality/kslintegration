function VismaDatabaseSpecification() {
     return {
         ...
         EmployeePosition: { tablename: 'EmployeePosition', columns: ['OrganisationId', 'SocialSecurityNumber', 'JobTitle', 'PrimaryPosition', 'ManagerPosition'], id_columns: ['OrganisationId', 'SocialSecurityNumber'], value_columns: ['JobTitle', 'PrimaryPosition','ManagerPosition'] },
     }
}
